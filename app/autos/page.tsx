...
import { Loader2, Filter, Car, X } from "lucide-react"
...
import { VehicleResultsMap } from "@/components/vehicles/vehicle-results-map"
...
export default function AutosPage() {
  ...
  return (
    <>
      ...
      <div id="catalogo-autos" className="mx-auto max-w-7xl px-3 pb-10 pt-4 sm:px-4 md:px-6 md:pt-6">
